                    ...
                    @endif
                      ...
                      {{ method_field($method) }}
                        ...
                        <div class="form-group">
													...
													<div class="col-md-8">
														<input type="text" class="form-control" name="name_sub_depart" value="{{ old('name_sub_depart') }}" >
														</div>
												</div>
                        ...
                        <div class="form-group">
													...
													<div class="col-md-8">
														<input type="text" class="form-control" name="sub_depart_sort" value="{{ old('sub_depart_sort') }}" >
														</div>
												</div>


											<div class="form-group">
                          <label class="col-md-3 control-label" for="exampleInputEmail1">รูปภาพ (370 x 247 px)*</label>
                          <div class="col-md-8">
