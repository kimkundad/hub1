                    ...
                    @endif
                      ...
                      {{ method_field($method) }}
                        ...
                        <div class="form-group">
													...
													<div class="col-md-8">
														<input type="text" class="form-control" name="te_name" value="{{ old('te_name') }}" id="profileFirstName">
													</div>
												</div>
												<div class="form-group">
                            ...
                            <select name="depart_id" class="form-control mb-md" required>
								                      ...
								                      @foreach($depart as $u)
													  <option value="{{$u->id}}">{{$u->name_department}}</option>
													  @endforeach
								                    </select>
														</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-8">
														<textarea class="form-control" rows="3" name="te_about" id="profileBio">{{ old('te_about') }}</textarea>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileFirstName">เบอร์ติดต่อ</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="te_phone" value="{{ old('te_phone') }}" id="profileFirstName">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileLastName">อีเมลครูผู้สอน</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="te_email" value="{{ old('te_email') }}" id="profileLastName">
													</div>
												</div>
                        <div class="form-group">
													<label class="col-md-3 control-label" for="profileCompany">อายุ*</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="te_old" value="{{ old('te_old') }}" id="profileCompany" >
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileCompany">facebook</label>
													<div class="col-md-8">
														<input type="number" class="form-control" name="te_facebook" value="{{ old('te_facebook') }}" id="profileCompany" >
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														<input type="number" class="form-control" name="te_twitter" value="{{ old('te_twitter') }}" id="profileCompany" >
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														<input type="number" class="form-control" name="te_ig" value="{{ old('te_ig') }}" id="profileCompany" >
													</div>
												</div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="fileupload fileupload-new" data-provides="fileupload">
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														<textarea class="form-control" rows="2" name="te_exper" id="summernote">{{ old('te_exper') }}</textarea>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														<textarea class="form-control" rows="2" name="te_edu" id="summernote2">{{ old('te_edu') }}</textarea>
													</div>
												</div>
