        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-content">
                    ...
                    <h2 class="breadcrumb__title">ค้นหาตามที่ค้นหา</h2>
                  <div class="text-outline">คอร์สเรียน</div>
                ...
                <div class="col-lg-12">
                    <div class="course-tab-wrap d-flex align-items-center">
                        <ul class="course-tab-list nav nav-tabs align-items-center" role="tablist"
                            ...
                            <li><span class="courses-showing-text">ค้นหา : <b>{{$search_text}}</b> มี {{$get_count}} คอร์ส ที่พบ</span></li>
                        </ul>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade show active" id="tab1">
                            <div class="row course-block">
                              ...
                              @if($get_count == 0)
                              <div class="col-lg-6">
                                <h2 class="text-danger">ไม่พบข้อมูลที่ค้นหา</h2>
                              </div><!-- end col-lg-6 -->
                              @else
