    ...
    transition-duration: 0.4s;
            ...
            <div class="col-lg-9">
                <div class="team-single-content">
                  ...
                  <h3 class="instructor-all-course__title " style="font-size: 1.25rem; margin-bottom:15px;"> Package ปัจจุบัน</h3>
                  ...
                  <div class="col-lg-2">
                     ...
                     <img class="img-fluid" src="{{url('assets/image/package/'.$u->package_image)}}" alt="{{$u->package_name}}">
                  </div>
                ...
                <!--  <tr>
                  ...
                  <h3 class="instructor-all-course__title " style="font-size: 1.25rem; margin-bottom:15px;"> Package รอการอนุมัติ</h3>
